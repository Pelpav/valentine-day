...
const Flowers = () => {
    ...
    useEffect(() => {
        const timeout = setTimeout(() => {
            ...
            if (bodyElement) {
                bodyElement.classList.remove("not-loaded");
            }
            clearTimeout(timeout);
        }, 100);
    }, []);
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', position: 'fixed', top: 500, left: 0, width: '100vw' }}>

            <section id="body" className="not-loaded">
                <div className="night"></div>
                <Link href="/" style={{ position: 'absolute', top: 20, left: 20, color: 'white', textDecoration: 'none' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M19 13H5v-2h14v2z" />
                        <path d="M7 10l5 5 5-5z" fill="none" stroke="currentColor" strokeWidth="2" />
                    </svg>
                </Link>
